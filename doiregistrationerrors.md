...
- the title has to be **absolutely consistent**. The title is not sometimes `<journal-title>TRAJECTA. RELIGION, CULTURE AND SOCIETY IN THE LOW COUNTRIES</journal-title>`, sometimes `<journal-title>Trajecta. Religion, Culture and Society in the Low Countries</journal-title>` and sometimes `<journal-title> Trajecta </journal-title>`. It is ever only `<journal-title>Trajecta</journal-title>`. Crossref recommends registering the title as it is registered in the ISSN centre.
